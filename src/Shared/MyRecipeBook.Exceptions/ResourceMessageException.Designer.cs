...
namespace MyRecipeBook.Exceptions {
    ...
    public class ResourceMessageException {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The name must not exceed 100 characters..
        /// </summary>
        public static string NAME_EXCEED {
            get {
                return ResourceManager.GetString("NAME_EXCEED", resourceCulture);
            }
        }
